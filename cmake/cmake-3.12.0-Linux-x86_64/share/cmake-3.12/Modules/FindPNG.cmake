...
message("-----------------------inner findzlib png modules--------------------------")
if(ZLIB_FOUND)
  ...
  find_path(PNG_PNG_INCLUDE_DIR 
	NAMES png.h  
	HINTS "${PNG_ROOT}" "${PNG_DIR}"
	PATH /usr/local/include/libpng  
	PATH_SUFFIXES 
	include)

message("-----------------------inner find png yse ${PNG_PNG_INCLUDE_DIR} modules--------------------------")
